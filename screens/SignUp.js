import { StyleSheet,
  ...
  TextInput,
  Modal, 
  FlatList, KeyboardAvoidingView, ScrollView, TouchableWithoutFeedback
} from 'react-native'
import LinearGradient from 'react-native-linear-gradient'
import { icons, images, FONTS, COLORS, SIZES} from '../constants/index'
  ...
  function renderHeader(){
    return(
      ...
      >
        ...
        <Text style={{marginLeft: SIZES.padding * 2, color: COLORS.white, ...FONTS.h4}}>Sign Up</Text>        
      </TouchableOpacity>
    )
  }
  function renderLogo(){
